...
/* package Scheme-implementation-in-Haskell-0.1.0.0 */
#ifndef VERSION_Scheme_implementation_in_Haskell
#define VERSION_Scheme_implementation_in_Haskell "0.1.0.0"
#endif /* VERSION_Scheme_implementation_in_Haskell */
#ifndef MIN_VERSION_Scheme_implementation_in_Haskell
#define MIN_VERSION_Scheme_implementation_in_Haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Scheme_implementation_in_Haskell */
...
#define CURRENT_COMPONENT_ID "Scheme-implementation-in-Haskell-0.1.0.0-inplace-Scheme-implementation-in-Haskell"
